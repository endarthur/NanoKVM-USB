...
Miracast (WiFi Display/WiDi) allows wireless screen transmission from the target PC to your controller PC. This is useful when you forgot your USB HDMI capture card or want a fully wireless setup.
...
3. Target PC's screen now visible in web interface!
```

## Lid Closed Setup

If you want to run target PC with lid closed:
...
**Windows setup:**
```powershell
# 1. Insert HDMI dummy into target PC
...
1. **Reduce resolution:** Lower target display to 1280x720
   ```
